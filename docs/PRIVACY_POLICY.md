...
O acesso a fotos ocorre somente quando o usuario escolhe uma imagem para um produto. Biometria e usada apenas para proteger o acesso local ao aplicativo. O aplicativo nao solicita contatos, localizacao, microfone ou acesso amplo aos arquivos.
