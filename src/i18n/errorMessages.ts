...
const errorKeyMap: Record<string, string> = {
  ...
  ADS_NO_FILL: 'errors.adsNoFill',
  ADS_NETWORK_ERROR: 'errors.adsNetworkError',
  ADS_INTERNAL_ERROR: 'errors.adsUnavailable',
  ADS_INVALID_REQUEST: 'errors.adsInvalidRequest',
  ADS_ALREADY_USED: 'errors.adsUnavailable',
  ADS_ALREADY_IN_PROGRESS: 'errors.adsAlreadyInProgress',
  ADS_UNAVAILABLE: 'errors.adsUnavailable',
  ADS_CANCELLED: 'ads.cancelled',
  AD_FREE_REWARD_ACTIVE: 'ads.adFreeActiveButton',
  AD_FREE_REWARD_LIMIT: 'ads.adFreeLimitReached',
  ...
  BACKUP_FILE_TOO_LARGE: 'errors.backupTooLarge',
  BACKUP_IMAGE_TOO_LARGE: 'errors.backupTooLarge',
  BACKUP_IMAGES_TOO_LARGE: 'errors.backupTooLarge',
  INVALID_BACKUP_ENTITLEMENT: 'errors.invalidBackupSchema',
  INVALID_BACKUP_IMAGE: 'errors.invalidBackupSchema',
  INVALID_BACKUP_SETTINGS: 'errors.invalidBackupSchema',
  DUPLICATE_BACKUP_ENTITLEMENT: 'errors.invalidBackupSchema',
  ...
  USER_NAME_TOO_LONG: 'errors.genericBody',
