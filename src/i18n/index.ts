...
const translations = {
  'pt-BR': {
    ...
    errors: {
      ...
      adsNoFill: 'Nao havia anuncio disponivel neste momento. A recompensa foi liberada como cortesia quando aplicavel.',
      adsNetworkError: 'Nao foi possivel acessar a rede de anuncios. Verifique sua conexao.',
      adsInvalidRequest: 'A configuracao do anuncio precisa ser revisada.',
      adsAlreadyInProgress: 'Um anuncio ja esta sendo preparado. Aguarde um instante.',
    ...
    ads: {
      ...
      preparing: 'Preparando anuncio... Isso pode levar alguns segundos na primeira vez.',
      courtesyPause: 'Nao havia anuncio disponivel. A pausa foi ativada como cortesia.',
      courtesyUnlock: 'Nao havia anuncio disponivel. O recurso foi liberado como cortesia.',
    },
    home: {
      greeting: 'Ola, {{name}}!',
      ...
      viewAlerts: 'Abrir central de alertas',
      zeroStock: 'Zerados',
      ...
      appFeaturesBody: 'Acesse diretamente backup, recompensas e recursos extras. Os recursos sao apresentados de forma transparente e continuam opcionais.',
      openBackup: 'Abrir backup e restauracao',
      openPremium: 'Abrir recompensas e recursos extras',
    },
    products: {
      title: 'Produtos',
    ...
    settings: {
      ...
      ads: 'Anuncios',
      adsBody: 'Os anuncios aparecem somente em areas nao essenciais. Voce pode revisar suas preferencias de privacidade a qualquer momento.',
    ...
    terms: {
      title: 'Termos de uso',
      subtitle: 'Regras claras para usar o EstoqueGuard Offline.',
      useTitle: 'Uso do aplicativo',
      useBody: 'O EstoqueGuard Offline organiza dados de estoque no seu aparelho. Ele nao substitui controles contabeis, fiscais, regulatorios ou profissionais. Revise os dados registrados antes de tomar decisoes para o seu negocio.',
      dataTitle: 'Dados e backups',
      dataBody: 'Voce e responsavel por manter backups adequados e guardar a senha dos backups criptografados. Senhas perdidas nao podem ser recuperadas. Seus dados principais permanecem no aparelho ate serem apagados por voce, pelo app ou pela desinstalacao.',
      adsTitle: 'Anuncios e recursos extras',
      adsBody: 'Cadastro e movimentacao de estoque nao dependem de anuncios. Alguns recursos secundários podem ser liberados voluntariamente por anuncios recompensados. As preferencias de publicidade podem ser revistas nas configuracoes.',
      contactTitle: 'Contato',
      contactBody: 'Para suporte, duvidas ou relatos sobre o aplicativo, entre em contato por jwmdevcreator@outlook.com.',
    },
    productNew: {
      title: 'Novo produto',
...
const enSupplemental: Record<string, any> = {
  ads: {
    ...
    preparing: 'Preparing ad... The first request may take a few seconds.',
    courtesyPause: 'No ad was available. The pause was activated as a courtesy.',
    courtesyUnlock: 'No ad was available. The feature was unlocked as a courtesy.',
  },
  home: {
...
const esSupplemental: Record<string, any> = {
  ads: {
    ...
    preparing: 'Preparando anuncio... La primera solicitud puede tardar unos segundos.',
    courtesyPause: 'No habia anuncios disponibles. La pausa fue activada como cortesia.',
    courtesyUnlock: 'No habia anuncios disponibles. La funcion fue liberada como cortesia.',
  },
  home: {
...
const translationsWithFallback: Record<Locale, TranslationTree> = {
  ...
  en: mergeTranslationTree({
    ...
    settings: { ...translations['pt-BR'].settings, title: 'Settings', profile: 'Profile', appearance: 'Appearance', theme: 'Theme', language: 'Language', currency: 'Currency', security: 'Security', data: 'Data', manageCategories: 'Manage categories', manageSuppliers: 'Manage suppliers', about: 'About', dangerZone: 'Danger zone', deleteAll: 'Delete all data', privacyPolicy: 'Privacy policy', contactSupport: 'Contact and support', termsOfUse: 'Terms of use', adsBody: 'Ads appear only in non-essential areas. You can review your privacy choices at any time.', manageAdPrivacy: 'Manage ad privacy', reportAd: 'Report an inappropriate ad', adsPrivacyFailed: 'Could not open ad privacy options.', linkFailed: 'Could not open this link.', saveFailed: 'Could not save the setting.', deleteFailed: 'Could not delete the data.' },
    terms: {
      title: 'Terms of use',
      subtitle: 'Clear rules for using StockGuard Offline.',
      useTitle: 'Using the app',
      useBody: 'StockGuard Offline organizes inventory data on your device. It does not replace accounting, tax, regulatory, or professional controls. Review saved information before making decisions for your business.',
      dataTitle: 'Data and backups',
      dataBody: 'You are responsible for maintaining appropriate backups and keeping encrypted backup passwords safe. Lost passwords cannot be recovered. Your main data remains on the device until you, the app, or an uninstall removes it.',
      adsTitle: 'Ads and extra features',
      adsBody: 'Product registration and stock movements do not depend on ads. Some secondary features can be voluntarily unlocked through rewarded ads. Advertising preferences can be reviewed in Settings.',
      contactTitle: 'Contact',
      contactBody: 'For support, questions, or reports about the app, contact jwmdevcreator@outlook.com.',
    },
  ...
  es: mergeTranslationTree({
    ...
    settings: { ...translations['pt-BR'].settings, title: 'Ajustes', profile: 'Perfil', appearance: 'Apariencia', theme: 'Tema', language: 'Idioma', currency: 'Moneda', security: 'Seguridad', data: 'Datos', manageCategories: 'Gestionar categorias', manageSuppliers: 'Gestionar proveedores', about: 'Acerca de', dangerZone: 'Zona de peligro', deleteAll: 'Borrar todos los datos', privacyPolicy: 'Politica de privacidad', contactSupport: 'Contacto y soporte', termsOfUse: 'Terminos de uso', adsBody: 'Los anuncios aparecen solo en areas no esenciales. Puedes revisar tus preferencias de privacidad en cualquier momento.', manageAdPrivacy: 'Gestionar privacidad de anuncios', reportAd: 'Denunciar un anuncio inapropiado', adsPrivacyFailed: 'No fue posible abrir las opciones de privacidad de anuncios.', linkFailed: 'No fue posible abrir este enlace.', saveFailed: 'No fue posible guardar la configuracion.', deleteFailed: 'No fue posible borrar los datos.' },
    terms: {
      title: 'Terminos de uso',
      subtitle: 'Reglas claras para usar StockGuard Offline.',
      useTitle: 'Uso de la aplicacion',
      useBody: 'StockGuard Offline organiza datos de inventario en tu dispositivo. No reemplaza controles contables, fiscales, regulatorios ni profesionales. Revisa los datos guardados antes de tomar decisiones para tu negocio.',
      dataTitle: 'Datos y copias de seguridad',
      dataBody: 'Eres responsable de mantener copias de seguridad adecuadas y guardar la contrasena de las copias cifradas. Las contrasenas perdidas no se pueden recuperar. Tus datos principales permanecen en el dispositivo hasta que tu, la app o la desinstalacion los eliminen.',
      adsTitle: 'Anuncios y funciones extra',
      adsBody: 'El registro de productos y los movimientos de stock no dependen de anuncios. Algunas funciones secundarias pueden desbloquearse voluntariamente mediante anuncios recompensados. Las preferencias de publicidad se pueden revisar en Ajustes.',
      contactTitle: 'Contacto',
      contactBody: 'Para soporte, dudas o reportes sobre la aplicacion, contacta a jwmdevcreator@outlook.com.',
    },
...
Object.assign(translationsWithFallback.en.errors, {
  ...
  adsNoFill: 'No ad was available right now. The reward was granted as a courtesy when applicable.',
  adsNetworkError: 'Could not reach the ad network. Check your connection.',
  adsInvalidRequest: 'The ad configuration needs to be reviewed.',
  adsAlreadyInProgress: 'An ad is already being prepared. Please wait a moment.',
...
Object.assign(translationsWithFallback.es.errors, {
  ...
  adsNoFill: 'No habia anuncios disponibles. La recompensa fue liberada como cortesia cuando corresponde.',
  adsNetworkError: 'No fue posible acceder a la red de anuncios. Revisa tu conexion.',
  adsInvalidRequest: 'La configuracion del anuncio debe ser revisada.',
  adsAlreadyInProgress: 'Ya se esta preparando un anuncio. Espera un momento.',
...
Object.assign(translationsWithFallback.en.home, {
  ...
  appFeaturesBody: 'Open backup, rewards, and extra features directly. These options are presented transparently and remain optional.',
  openBackup: 'Open backup and restore',
  openPremium: 'Open rewards and extra features',
});

Object.assign(translationsWithFallback.en.home, {
  viewAlerts: 'Open alert center',
});

Object.assign(translationsWithFallback.es.home, {
  viewAlerts: 'Abrir centro de alertas',
});
...
Object.assign(translationsWithFallback.es.home, {
  ...
  appFeaturesBody: 'Accede directamente a copias de seguridad, recompensas y funciones extra. Estas opciones se presentan de forma transparente y siguen siendo opcionales.',
  openBackup: 'Abrir copia y restauracion',
  openPremium: 'Abrir recompensas y funciones extra',
});
